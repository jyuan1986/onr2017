...
for m in MA:
 for n in NA:
  ...
  if n==1:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m), shuffle=False,random_state=random_state)
  elif n==2:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m, m), shuffle=False,random_state=random_state)
  elif n==3:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m, m, m), shuffle=False,random_state=random_state)
  elif n==4:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m, m, m, m), shuffle=False,random_state=random_state)
  elif n==5:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m, m, m, m, m), shuffle=False,random_state=random_state)
  elif n==6:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m, m, m,m,m,m), shuffle=False,random_state=random_state)
  elif n==7:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m, m, m,m,m,m,m), shuffle=False,random_state=random_state)
  elif n==8:
    clf = MLPRegressor(solver='lbfgs', alpha=alpha,hidden_layer_sizes=(m, m, m,m,m,m,m,m), shuffle=False,random_state=random_state)
